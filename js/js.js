...
function init() {
    ...
    let today = new Date();
    /* Temporizador para completar el juego */
    ...
    /* Girar la cuchilla infinitamente */
    ...
    function customPropeller(element) {
        ...
        return new Propeller(el, {
            ...
            onRotate: function () {
                /* Agrega un efecto brillante si el círculo está en la posición correcta */
...
/* Posicionar los círculos en posición aleatoria */
